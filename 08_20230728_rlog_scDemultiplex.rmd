...
for(sample in samples){
  ...
  rlog_prefix=paste0(sample_dir, "/scDemultiplex.rlog/", sample, ".HTO_")
  ...
  final_df = rbind(final_df, data.frame(sample=sample, clr_ari=clr_ari, rlog_ari=rlog_ari, clr_fscore=clr_fscore, rlog_fscore=rlog_fscore))
